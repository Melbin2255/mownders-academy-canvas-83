...
const WhatsAppWidget = () => {
  const whatsappNumber = '9947835210';
  const message = encodeURIComponent("Hi Mownder's Academy! I'd like to inquire about your services.");
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        animate={{
          boxShadow: ['0px 0px 0px rgba(0, 0, 0, 0.2)', '0px 0px 15px rgba(37, 211, 102, 0.5)', '0px 0px 0px rgba(0, 0, 0, 0.2)'],
        }}
        transition={{
          duration: 2,
          ease: "easeInOut",
      ...
      <motion.div
        ...
        className="absolute bottom-16 right-0 bg-white p-3 rounded-lg shadow-lg text-sm w-48 text-center mb-2"
      >
